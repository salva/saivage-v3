...
This file is a deployable prompt asset for the Saivage Reviewer role. The runtime currently renders reviewer prompts from `src/agents/prompts/system-prompt.ts`; this asset is packaged into `dist/prompts/reviewer.md` so deployment layouts have a stable prompt asset directory.
