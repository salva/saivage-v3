...
export const messageKindSchema = z.enum(['text', 'activity', 'tool_call', 'tool_result', 'model_issue', 'model_repair', 'content_policy_retry', 'content_policy_refusal', 'context_compaction', 'model_recovered', 'system_prompt', 'provider_private']);
