...
export const runtimeRunRecordSchema: z.ZodType<import('./types.js').RuntimeRunRecord> = z.object({ run_id: z.string().min(1), kind: runtimeRunKindSchema, card_id: z.string().min(1), ownership: runtimeDispatchOwnershipSchema, parent_run_id: z.string().nullable().optional(), command_id: z.string().nullable().optional(), activation_id: z.string().nullable().optional(), phase: runtimeRunPhaseSchema, runtime_status: activeCardRunRuntimeStatusSchema, session_id: z.string().nullable().optional(), started_at: z.string().datetime(), updated_at: z.string().datetime(), finished_at: z.string().datetime().nullable().optional(), outcome: runtimeRunOutcomeSchema.nullable().optional() }).strict().superRefine((run, ctx) => {
