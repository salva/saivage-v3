...
export const invocationSucceededEventSchema = passthroughBaseEventSchema.extend({ kind: z.literal('invocation_succeeded'), session_id: z.string(), role: agentRoleSchema, attempt: z.number(), duration_ms: z.number(), terminal_tool: z.enum(['emit_planner_result', 'emit_executor_result', 'emit_reviewer_result']).nullable() });
