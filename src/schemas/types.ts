...
export type LlmAttemptOutcome =
  | { kind: 'succeeded'; terminal_tool: 'emit_planner_result' | 'emit_planner_deferred' | 'emit_executor_result' | 'emit_reviewer_result' }
