...
export type LoggedEvent = ProcessReconciledDeadEvent | ProcessReattachRejectedEvent | GoalReportRejectedEvent | StartedEvent | GoalCompletedEvent | GoalFailedEvent | CardFailedEvent | ReviewCompleteEvent | ReviewFailedEvent | DispatchBlockedEvent | DispatchInterruptedEvent | DispatchHeldForNotificationEvent | EscalationEvent | PlanUpdatedEvent | PausedEvent | ResumedEvent | ShutdownEvent | ErrorEvent | ProjectRunCompletedEvent | StuckSupervisorStartedEvent | StuckSupervisorStoppedEvent | StuckVerdictEvent | AbortTargetSelectedEvent | ForceCancelSentEvent | SessionStartedEvent | ModelSelectedEvent | InvocationSucceededEvent | InvocationFailedEvent | RetryAttemptedEvent | CompactionTriggeredEvent | SelfCheckTriggeredEvent | ModelIssueEvent | SessionCancelledEvent | SessionForceCancelledEvent | McpToolInvocationEvent;
