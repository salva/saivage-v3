...
Execution guidance:
- When this card type designates Executor as notification recipient, treat delivered notification context as current evidence and reconsider the present node before emitting a result. Do not infer or inspect pending queue state.
