...
export const ANALYST_TOOL_DEFINITIONS: ToolDefinition[] = [
  ...
  tool('reorder_child','Reorder a parent card child list. S03 owns ordered children; S02 reports not-yet-available.',{ parentId: str('Parent card id.'), orderedChildIds: arr(str('Child card id'),'Complete desired child id order.') },['parentId','orderedChildIds']),
