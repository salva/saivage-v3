...
function extractContractRoutes(projectRoot) {
  const contractPaths = ['src/contracts/operator-api.ts', 'src/contracts/operator-api-agents.ts'].map((relPath) => join(projectRoot, relPath));
