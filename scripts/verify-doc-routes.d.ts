...
export interface RuntimeControlDocRow {
  request: string;
  response: string;
  anchor: string;
}
...
export interface RuntimeControlVerificationOptions {
  projectRoot?: string;
  rows?: Map<string, RuntimeControlDocRow>;
}
...
export interface DocSourceContractsResult {
  ...
  runtimeControlResult: GenericVerificationResult;
  configResult: GenericVerificationResult;
}
...
export function verifyRuntimeControlDocs(options?: RuntimeControlVerificationOptions): GenericVerificationResult;
export function verifyConfigDocs(options?: ConfigVerificationOptions): GenericVerificationResult;
