...
- The specified exact-session final-unmatched settlement at actual activation use is the narrow exception to entry stabilization. It authorizes neither proactive cleanliness/preflight passes nor inspection or stabilization of any session not selected for that imminent activation.
