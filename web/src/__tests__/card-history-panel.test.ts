...
describe('CardHistoryPanel', () => {
  ...
  beforeEach(() => { vi.clearAllMocks(); pinia = createPinia(); setActivePinia(pinia); useCardStore().selectedDetail = { cardId: CARD, card: cardView(CARD, { title: 'after', version_seq: 3 }), records: [] }; });
