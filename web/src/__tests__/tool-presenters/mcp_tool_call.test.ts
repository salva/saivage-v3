...
describe('mcp_tool_call presenter', () => {
  it('renders a structured call presentation for mcp_tool_call', () => {
    const view = presentToolCall(callEnvelope('mcp_tool_call', { path: '.saivage/plan.json', command: 'npm test', cardId: 'card-1', id: 'card-1', goalId: 'goal-1', sessionId: 'session-1', content: 'hello' }));
