...
describe('read presenter', () => {
  it('renders a structured call presentation for read', () => {
    const view = presentToolCall(callEnvelope('read', { path: '.saivage/plan.json', command: 'npm test', cardId: 'card-1', id: 'card-1', goalId: 'goal-1', sessionId: 'session-1', content: 'hello' }));
