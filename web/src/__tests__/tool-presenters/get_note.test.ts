...
describe('get_note presenter', () => {
  it('renders a structured call presentation for get_note', () => {
    const view = presentToolCall(callEnvelope('get_note', { path: '.saivage/plan.json', command: 'npm test', cardId: 'card-1', id: 'card-1', goalId: 'goal-1', sessionId: 'session-1', content: 'hello' }));
