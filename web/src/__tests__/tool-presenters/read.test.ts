...
describe('read presenter', () => {
  it('renders a structured call presentation for read', () => {
    const view = presentToolCall(callEnvelope('read', { path: '.saivage/plan.json', command: 'npm test', cardId: '11111111-1111-4111-8111-111111111111', id: '11111111-1111-4111-8111-111111111111', goalId: '11111111-1111-4111-8111-111111111111', sessionId: 'session-1', content: 'hello' }));
