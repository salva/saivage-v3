...
describe('glob presenter', () => {
  it('renders a structured call presentation for glob', () => {
    const view = presentToolCall(callEnvelope('glob', { directory: '.', pattern: '**/*.ts', command: 'npm test', cardId: 'card-1', id: 'card-1', goalId: 'goal-1', sessionId: 'session-1', content: 'hello' }));
