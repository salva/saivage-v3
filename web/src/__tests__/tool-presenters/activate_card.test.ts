...
describe('activate_card presenter', () => {
  it('renders a structured call presentation for activate_card', () => {
    const view = presentToolCall(callEnvelope('activate_card', { path: '.saivage/plan.json', command: 'npm test', cardId: 'card-1', id: 'card-1', goalId: 'goal-1', sessionId: 'session-1', content: 'hello' }));
