...
describe('debug-read-model', () => {
  ...
  it('groups doctor and supervision projections without store-only computed state', () => {
    ...
    const issues: DoctorIssue[] = [
      ...
      { severity: 'warning', message: 'Orphan file .saivage/work/output/xyz.log' },
    ];
    const reviews: ContentReview[] = [
      { id: 'r1', source_kind: 'command_output', source_ref: 'proc-1/stdout', status: 'passed', summary: 'No sensitive data detected', risk: 'low', created_at: '2025-06-01T10:00:00Z' },
      { id: 'r2', source_kind: 'file', source_ref: '.saivage/work/output/report.md', status: 'blocked', summary: 'Contains PII pattern', risk: 'high', created_at: '2025-06-01T10:05:00Z' },
      { id: 'r3', source_kind: 'download', source_ref: 'https://example.com/data.csv', status: 'sanitized', summary: 'PII redacted', risk: 'medium', created_at: '2025-06-01T10:10:00Z' },
    ];
