...
import { adaptChatMessageToToolChip } from '../chat/tool-chip-adapter';
...
function toolPairProps(pair: ToolPair, expanded: boolean) { return adaptChatMessageToToolChip(pair.call, pair.result, expanded); }
</script>
