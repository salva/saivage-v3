---
description: End-to-end fixer for one Saivage v3 issue. Use when a bug, regression, behavior gap, review finding, or architectural issue requires mandatory design, adversarial review, freshness checking, and serialized implementation-manager execution.
mode: all
...
At completion, report the issue, design/plan path, key files changed, manager-supplied validation results and commit hashes, and repository stability. Post-manager reporting remains read-only.
