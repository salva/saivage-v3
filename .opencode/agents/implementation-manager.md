...
5. Remove `~/implementation-manager-working.md` only when this implementation-manager run is ending and you created the file for this run. Do not remove a file created by another run.
