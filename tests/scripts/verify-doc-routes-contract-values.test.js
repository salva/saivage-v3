...
const SOURCE_MUTATIONS = [
  ...
  ['history service selection', verifyErrorShapeDocs, 'src/cards/card-service.ts', 'readCardVersion(this.projectRoot, id, version, instrumentation)'],
  ...
  ['backend service omitted/current meaning', verifyCardDiffPivotDocs, 'src/cards/card-service.ts', "pivots.toVersion === undefined || pivots.toVersion === 'current'"],
  ['backend service current artifact', verifyCardDiffPivotDocs, 'src/cards/card-service.ts', 'readCurrentCardArtifact(this.projectRoot, id, instrumentation)'],
  ...[
