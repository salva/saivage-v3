...
const EXPECTED_CATALOG = {
  ...
  'constant.summarizer-output-max-bytes': ['constants', ['src/runtime/actors/compaction/summarizer.ts']],
...
const CONSTANT_OCCURRENCE_SPECS = [
  ...
  ['src/runtime/actors/compaction/summarizer.ts', 'SUMMARY_OUTPUT_MAX_BYTES'],
