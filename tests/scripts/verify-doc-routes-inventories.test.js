...
describe('source-derived named-agent tool inventory', () => {
  it('discovers the exact default named-agent inventories', () => {
    ...
    expect(Object.fromEntries(result.expected)).toEqual({
      planner: ['activate_card', 'cancel_card', 'create_card', 'diff_card_versions', 'edit', 'edit_card', 'get_card', 'get_card_version', 'get_tree', 'glob', 'grep', 'list_card_versions', 'list_cards', 'queue_notification', 'read', 'reorder_child', 'webfetch', 'websearch', 'write'],
      reviewer: ['diff_card_versions', 'edit', 'get_card_version', 'glob', 'grep', 'list_card_versions', 'read', 'skill', 'webfetch', 'websearch', 'write'],
      executor: ['apply_patch', 'diff_card_versions', 'edit', 'get_card_version', 'glob', 'grep', 'kill_process', 'list_card_versions', 'mcp_tool_call', 'read', 'run_command', 'skill', 'wait_process', 'webfetch', 'websearch', 'write'],
      analyst: ['apply_patch', 'cancel_card', 'create_card', 'delete_card', 'diff_card_versions', 'edit', 'get_card', 'get_card_version', 'get_status', 'get_tree', 'glob', 'grep', 'kill_process', 'list_agent_sessions', 'list_card_versions', 'list_cards', 'list_processes_tool', 'mcp_reconcile', 'mcp_tool_call', 'navigate_back', 'navigate_workspace', 'pause_runtime', 'queue_notification', 'read', 'read_agent_session', 'read_control_actions', 'read_runtime_errors', 'read_runtime_events', 'reconfigure', 'reopen_card', 'reorder_child', 'restart_server', 'resume_runtime', 'run_command', 'show_config', 'skill', 'start_project', 'stop_project', 'wait_process', 'webfetch', 'websearch', 'write'],
    });
  });
