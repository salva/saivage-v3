...
describe('source-derived named-agent tool inventory', () => {
  it('discovers the exact default named-agent inventories', () => {
    ...
    expect(Object.fromEntries(result.expected)).toEqual({
      planner: ['activate_card', 'cancel_card', 'create_card', 'diff_card_versions', 'edit', 'edit_card', 'get_card', 'get_card_version', 'get_tree', 'glob', 'grep', 'list_card_versions', 'list_cards', 'queue_notification', 'read', 'read_record_version', 'reorder_child', 'webfetch', 'websearch', 'write'],
