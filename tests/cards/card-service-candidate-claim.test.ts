...
const roots: string[] = [];
const input = { type: 'code' as const, parent: 'project', title: 'Claim', bootstrap_content: 'Claim directly.', tags: [], priority: 0, urgency: 'normal' as const, created_by: 'analyst' as const, depends_on: [], related: [] };
