import { initProjectTree, CardStore, testCardRepository, testConfigAuthority } from '../helpers/canonical-project.js';
...
beforeAll(async () => {
  ...
  registerOperatorContractRoutes({ fastify: app, projectRoot: TEST_ROOT, configAuthority: testConfigAuthority(TEST_ROOT), cardStore: testCardRepository(TEST_ROOT), authPolicy: new AuthPolicy({ apiToken: authToken }) });
