...
async function toolCallFixture(toolName:string){
  ...
  const preparedCompaction=prepareCompaction({input_budget_tokens:10000,trigger_fraction:.8,completion_reserve_fraction:.2,tail_fraction:.25,snap:'compact_straddler'},'system',[]);
