...
function record(overrides: Partial<ProcessRecord> = {}): ProcessRecord {
  return {
    ...
    output_dir: '/workspace/project/.saivage/work/cards/card-1/processes/proc-1',
    stdout_path: '/workspace/project/.saivage/work/cards/card-1/processes/proc-1/stdout.log',
    stderr_path: '/workspace/project/.saivage/work/cards/card-1/processes/proc-1/stderr.log',
