...
const base = { candidate: { provider: 'test', account: null, model: 'model' }, systemPrompt: 'system', providerConversation: { sourceSessionId: 'planner:project', messages: [] }, options: { inputId: '00000000-0000-4000-8000-000000000001', phase: 'tools' as const, contract_id: 'planner.v1', contractName: 'planner', terminalToolOffered: [], tools: [], tool_choice: { kind: 'auto' as const }, max_tokens: 321 } };
...
describe('candidate request admission artifact', () => {
  ...
  it('keeps Responses-private output transport-private while admission counts its exact serialized bytes', () => {
    ...
    const common = { session_id: 'planner:project', round_id: 'r-assistant-00000000000000000000000000000000', message_index: 1, block_index: 0, timestamp: '2026-07-17T00:00:00.000Z' };
    ...
    const providerConversation = { sourceSessionId: 'planner:project', messages: [privateRow, visible] };
