...
export function invocationProviderRegistry(candidates: readonly Candidate[], capabilitiesFor?: (candidate: Candidate) => Partial<NonNullable<SaivageConfig['providers'][string]['capabilities']>>): ProviderRegistry {
