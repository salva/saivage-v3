...
function setupRoot(): string {
  ...
  writeFileSync(join(sd, 'cards', 'by-id', 'c-1.json'), JSON.stringify({ id: 'c-1', type: 'code', parent: 'project', depth: 1, title: 'card', description: '', status: 'backlog', tags: [], priority: 0, urgency: 'normal', created_by: 'analyst', created_at: now, updated_at: now, version_seq: 1, depends_on: [], related: [], acceptance: '', artifacts: [], attachments: [], retries: 0 }));
