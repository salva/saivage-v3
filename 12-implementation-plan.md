...
- `01-card-model.md` for card semantics and planner/reviewer gates.
- `03-agents.md` for agent roles and tool boundaries.
- `04-runtime.md` for dispatch, recovery, locking, and processes.
- `05-security.md` for content supervision and access rules.
- `06-configuration.md` for configuration and provider routing.
- `08-server-api.md` for HTTP/WebSocket surface.
- `09-data-model.md` for schemas and file layout.
- `10-ux-design.md` for the web UI.
...
- All records from `09-data-model.md` have corresponding TypeScript
...
- Enforce hierarchy rules from `01-card-model.md`.
...
- A new project initializes the file tree from `09-data-model.md`.
...
- Implement card, runtime, agent conversation, config, notes, chat,
  files, and debug endpoints from `08-server-api.md`.
...
- Implement the Vue SPA from `10-ux-design.md`.
