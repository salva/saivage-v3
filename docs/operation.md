...
| `GET /api/control-actions` | List control-action audit entries. | `src/server/routes/runtime-config-notes.ts:194` |
...
| `GET /api/notes` | List unhandled notes. | `src/server/routes/runtime-config-notes.ts:213` |
