...
the same enum in
[`deriveTerminalToolFromOptions`](../../../src/agents/llm-recording.ts#L58)
and [`asTerminalToolName`](../../../src/agents/llm-recording.ts#L54).
...
which the [`RoleToolPolicy`](../../../src/agents/role-tool-policy.ts#L75)
...
5. The contracts layer's recording schemas and re-exports plus the
   ...
   [llm-recording.ts#L58](../../../src/agents/llm-recording.ts#L58)).
...
- The executor schema
  ...
  ([system-prompt.ts#L140](../../../src/agents/system-prompt.ts#L140))
...
non-contractual.
[`agent-role-runner.ts#L36`](../../../src/agents/agent-role-runner.ts#L36)
...
- [`parseDeferredActivationEnvelope`](../../../src/schemas/validators.ts#L62)
...
- `applyPlannerResult` in
  [runtime.ts#L822-L840](../../../src/runtime/runtime.ts#L822)
...
- The session-persistence scanner
  [`findUniqueUnresolvedActivateCardToolCall`](../../../src/agents/session-persistence.ts#L405)
  ...
  ([L405-L432](../../../src/agents/session-persistence.ts#L405)).
- The completion-side writer
  [`appendActivateCardToolResultOnce`](../../../src/agents/session-persistence.ts#L446)
  persists the activation-completion tool result idempotently when a
  child terminates ([L446-L461](../../../src/agents/session-persistence.ts#L446)).
- The runtime keeps a parallel unresolved-activation scanner
  [`findUnresolvedActivateCards`](../../../src/runtime/runtime.ts#L239)
  ([L239-L262](../../../src/runtime/runtime.ts#L239)) that recognises a
  completion only when
  [`parseActivationCompletionEnvelope`](../../../src/schemas/validators.ts#L74)
