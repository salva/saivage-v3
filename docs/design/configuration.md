...
> **Authority status: stale.** This page is retained for context only and is not current operator guidance. Prefer `docs/configuration.md` for current authority where applicable.
