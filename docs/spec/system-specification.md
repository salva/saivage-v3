...
Diagnostic, control-action, process, and agent-session tool result bodies remain arbitrary and are bounded only when exact compaction materialization and request admission admit a subsequent provider request.
