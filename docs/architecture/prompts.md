...
| `src/config/system-templates/<name>/prompts/**` | per-template bundled tree equal to that template's exact compiler-observed source closure, including the five shared project-guidance fragments and all process prompts selected by that template |
