...
This directory contains only current Saivage v3 architecture documentation. Superseded design provenance is available through Git history and is not implementation authority.
