...
| Role | Tools | Source |
|---|---|---|
| `planner` | `cancel_card,create_card,queue_notification,reorder_child` | `src/tools/analyst-card-tools.ts:241` |
