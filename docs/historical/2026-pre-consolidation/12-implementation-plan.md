...
- `docs/design/agents.md` for agent roles and tool boundaries.
- `docs/design/runtime.md` for dispatch, recovery, locking, and processes.
- `docs/design/security.md` for content supervision and access rules.
- `docs/design/configuration.md` for configuration and provider routing.
- `docs/design/server-api.md` for HTTP/WebSocket surface.
- `docs/design/data-model.md` for schemas and file layout.
...
- All records from `docs/design/data-model.md` have corresponding TypeScript
...
- A new project initializes the file tree from `docs/design/data-model.md`.
...
- Implement card, runtime, agent conversation, config, notes, chat,
  files, and debug endpoints from `docs/design/server-api.md`.
