...
## Denied control action

Mutating controls use a static authorization table keyed by actor, surface, and safety class. The verdict is `allow` or `deny`; there is no interactive confirmation gate.
