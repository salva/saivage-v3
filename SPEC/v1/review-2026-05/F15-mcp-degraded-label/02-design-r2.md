...
Reviewer (r1) approved the design as written; no findings were raised against this document. The content below is unchanged from [02-design-r1.md](02-design-r1.md) and is reproduced here only to keep the round-2 trio self-contained.
...
The illustrative per-value comments shown in r1 are NOT to be copied into the production file; the plan keeps the enum line a pure data declaration. Semantics are documented in [docs/operation.md](../../../docs/operation.md).
